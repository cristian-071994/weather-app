    ...
    <section className="text-xl">
      ...
      <section className="grid gap-4 sm:grid-cols-two">
        <article className="bg-slate-300/70 rounded-3xl grid grid-cols-2 justify-items-center items-center py-2 sm:px-2">
          <h3 className="capitalize col-start-1 col-end-3 py-2">{weather.weather[0].description}</h3>

          <h2 className="text-[45px] font-light sm:text-6xl">{isCelsius ? `${celsius} °C` : `${fahrenheit} °F`}</h2>
          <div>
            <img
